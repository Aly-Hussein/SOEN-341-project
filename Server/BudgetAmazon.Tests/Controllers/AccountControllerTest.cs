...
namespace BudgetAmazon.Tests.Controllers
{
    ...
    public class AccountControllerTest 
    {
        ...
        [TestMethod]
        public void Login_OnOpen_IsNotNull()
        {
            AccountController accountController = new AccountController();

            var result = accountController.Login(null) as ViewResult;

            Assert.IsNotNull(result);
        }

        [TestMethod]
        public void VerifyCode_OnOpen_IsNotNull()
        {
            AccountController accountController = new AccountController();

            var result = accountController.VerifyCode(null);
